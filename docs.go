...
// in [go.alis.build/adk/a2ui/spec] and against the negotiated catalog.
//
// # Subpackages
//
...
//   - [go.alis.build/adk/a2ui/v09], [go.alis.build/adk/a2ui/v09/tools]: A2UI v0.9 and v0.9.1.
//   - [go.alis.build/adk/a2ui/v10], [go.alis.build/adk/a2ui/v10/tools]: A2UI v1.0.
//
// [A2UI]: https://a2ui.org/
package a2ui
